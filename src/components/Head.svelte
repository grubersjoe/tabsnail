<script lang="ts">
  ...
  import Eyestalk from '@/components/Eyestalk.svelte'
  import type { Side } from '@/lib/layout.ts'
...
<style>
  .head {
    position: relative;
    pointer-events: all;
    background: var(--head-bg, #eee);
    box-shadow: 0 0 var(--outline-width) var(--color-outline);
    width: 100%;
    height: 100%;
